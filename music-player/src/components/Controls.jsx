...
const Controls = () => {
    ...
    const { audioRef, progressBarRef, duration, setTimeProgress, tracks, trackIndex, trackIndexFromList, setTrack, setTrackIndex, setTrackIndexFromList, handleNext } = useTrack()
    ...
    useEffect(() => {
        ...
        audioRef.current.mute = muteVolume;
    ...
    return (
        <div className="controls-container">
            ...
            <div className="volume">
                <button className="volumr-button" onClick={() => setMuteVolume((prev) => !prev)}>
